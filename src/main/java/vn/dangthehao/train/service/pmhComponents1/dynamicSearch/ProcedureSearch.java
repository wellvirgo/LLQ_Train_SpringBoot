...
public class ProcedureSearch implements SearchComponentService {
  ...
  public PageResult<PmhComponents1> search(SearchPmhComponentRequest request) {
    log.info(SearchTech.PROCEDURE.name());
    return pmhComponents1Repository.findAllUseProcedure(request);
  }
}
